...
仓库附有一篇完整的 22 页数学建模参考论文：[《月上柳梢头，人约黄昏后：标准化天文情景的严格判定与稳健分析》](assets/readme/sample-paper-unoptimized.pdf)。它示范如何先限定题意与场景边界，再完成建模、数值求解、外部核验、敏感性分析和结论降级；用于参考正确的交付与论证方式，而不是直接套用题目结论。

<p align="center">
  <a href="assets/readme/sample-paper-unoptimized.pdf">
    <img src="assets/readme/sample-paper-preview.png" alt="规范操作范文首页预览" width="580" />
  </a>
</p>
